...
public class MainView extends JFrame {
    ...
    private void renderizarListagemServico() {
        ...
        telaListagemServico.getButtonEditService().addActionListener(e -> {
            Long idServico = telaListagemServico.getSelectedService();
           renderizarEditarServico(idServico);
        });
    ...
    private void renderizarEditarServico(Long idServico) {
        EditarServico editarServico = new EditarServico(idServico);
    ...
    private void renderizarEditarPet(Long idPet) {
        EditarPet editarPet = new EditarPet(idPet);
    ...
    private void renderizarListagemPet() {
        ...
        listagemPet.getEditarBtn().addActionListener(e1 ->{
            Long idPet = (listagemPet.getSelectedPet());
            renderizarEditarPet(idPet);
        });
        listagemPet.getCadastrarBtn().addActionListener(e2 ->{
